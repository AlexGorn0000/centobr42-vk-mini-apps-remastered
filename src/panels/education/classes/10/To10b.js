...
class To10b extends React.Component {
  constructor(props){
  super(props);
  this.state = {};
  ...
  return(
	...
	<PanelHeader left={<HeaderButton onClick={this.props.go} Data-to="Timetable"><Icon24BrowserBack/></HeaderButton>}>10 «Б» класс</PanelHeader>
  <Group>
  <Div>Понедельник<br/>
